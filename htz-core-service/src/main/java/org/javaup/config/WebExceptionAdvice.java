...
import org.javaup.exception.HtzFrameException;
...
public class WebExceptionAdvice {
     ...
     * 业务异常
     * */
    @ExceptionHandler(value = HtzFrameException.class)
    public Result<String> toolkitExceptionHandler(HttpServletRequest request, HtzFrameException htzFrameException) {
        log.error("业务异常 错误信息 : {} method : {} url : {} query : {} ", htzFrameException.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), htzFrameException);
        return Result.fail( htzFrameException.getMessage());
    }
    /**
     * 参数验证异常
     */
